...
const LUMINA_TRANSLATIONS = {
    es: {
        ...
        'alert.iniciar_sesion_funcion': 'You must log in to use this function.',
        'alert.iniciar_sesion_comentar': 'Log in to comment',
        'alert.confirmar_cerrar_sesion': 'Are you sure you want to log out?',
        'alert.confirmar_cerrar_sesion': '¿Estás seguro de que deseas cerrar sesión?',
